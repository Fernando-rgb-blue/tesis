...
const DeleteBooks = () => {
    ...
    const handleDelete = async (id) => {
        ...
        Swal.fire({
            title: "¿Desea eliminar de forma definitiva este libro?",
    ...
    const handleHabilitacion = async (id) => {
        Swal.fire({
            title: "¿Estás seguro de activar el libro?",
            text: "El libro lo encontrará en la pagina principal",
            icon: "question",
            showCancelButton: true,
            ...
            if (result.isConfirmed) {
                try {
                    ...
                    Swal.fire("Activado", "El libro ha sido activado.", "success");
                } catch (error) {
                ...
                <Table aria-label="Gestión de Libros" className="w-full table-fixed">
                    ...
                    <TableBody>
                        {paginatedFilteredBooks
                            .filter((libro) => libro.habilitacion === 0) // Filtrar solo los libros habilitados
                            .sort((a, b) =>
                                sortOrder === 'asc'
                                    ...
                                    <TableCell className="text-center text-xs">
                                        <div className="flex justify-center space-x-2">
                                            ...
                                            <button
                                                ...
                                                className="bg-green-500 hover:bg-green-600 text-white font-bold py-1 px-3 rounded-lg text-xs flex items-center justify-center"
                                            >
